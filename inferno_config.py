...
MIN_CREDIT_SPREAD_CREDIT_RISK = float(os.environ.get("MIN_CREDIT_SPREAD_CREDIT_RISK", "0.20"))
MAX_UNDERLYING_SOURCE_DIVERGENCE_PCT = float(os.environ.get("MAX_UNDERLYING_SOURCE_DIVERGENCE_PCT", "5.0"))
