...
def build_strike_plan_for_intent(
    ...
    base = {
        ...
        "priorityScore": intent.get("priorityScore") or intent.get("priority"),
        "scenarioScore": intent.get("scenarioScore"),
        "setupFamily": intent.get("setupFamily") or intent.get("routeFamily"),
        "routeFamily": intent.get("routeFamily"),
        "primaryRoute": intent.get("primaryRoute"),
        "secondaryRoute": intent.get("secondaryRoute"),
        "sourceLane": intent.get("sourceLane"),
        "sourceFamily": intent.get("sourceFamily"),
        "sourceRecommendedStrategy": intent.get("sourceRecommendedStrategy"),
        "sourceAlternativeScore": intent.get("sourceAlternativeScore"),
        "sourceAlternativeRawScore": intent.get("sourceAlternativeRawScore"),
        "sourceAlternativeEdgeVsLongVol": intent.get("sourceAlternativeEdgeVsLongVol"),
        "sourceAlternativeWarnings": intent.get("sourceAlternativeWarnings") or [],
